...
import { IonicPage, NavController, NavParams , MenuController, ModalController,Events, ToastController, Loading, LoadingController} from 'ionic-angular';
                                       ...
                                       if (existe < 0) {
                                         ...
                                         .then((data: any) => {
                                              ...
                                              this.data.sobrenome = result.data_user.last_name;
                                               ...
                                               if(data){
                                                //console.log("uusuario criado", result.data_user.last_name);
                                              }
                                         ...
                                         .then((data: any) => {
                                                ...
                                                this.events.publish('dados',this.data);
                                                if(data){
                                                  //console.log("uusuario atualizado", result.data_user.last_name);
                                                }
                                                this.navCtrl.setRoot('HomePage');  
