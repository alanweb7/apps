...
pushPagePesquisa(){
  ...
  this.navCtrl.push('CodePesquisaPage',{texto_corpo:this.texto_corpo,title:this.title,texto:this.texto,campo:this.campo,page_pesquisa:this.page_consulta,msg_servidor:this.msg_servidor,load_aguarde:this.load_aguarde,token:this.token,lang:this.language});
 // myModal.present();
}
showCheckbox() {
...
private _initialiseTranslation() : void
{
   setTimeout(() =>
   {
      ...
      this.texto_corpo           = this.translate.instant("default.texto_corpo");
      ...
      this.btn_continuar          =this.translate.instant("default.btn_ok");
      ...
      this.digite             =this.translate.instant("default.digite");
      this.code             =this.translate.instant("default.code");
