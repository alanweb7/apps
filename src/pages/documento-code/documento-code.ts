...
export class DocumentoCodePage {
  ...
  ionViewDidLoad() {
    ...
    //console.log('ionViewDidLoad DocumentoCodePage');
    this.getDocServe();
  }
  ...
  private takePicture(): void {
    ...
    const options: CameraOptions = {
     ...
     this.camera.getPicture(options).then((imageData) => {
       ...
       //console.log("extesino",this.util.getExtension(imageData));
        ...
        //console.log("list image"+this.docs);
