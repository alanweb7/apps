...
export class CodePesquisaPage {
  ...
  ionViewDidLoad() {
    ...
    this.texto_corpo            = this.navParams.get('texto_corpo');
    this.texto_corpo_orig            = this.navParams.get('texto_corpo');
    this.pushGeoinfo();
    //this.texto_corpo=;
...
setFilteredItems() {
 ...
 closeModal() {
  ...
  onCancel(){
    this.texto_corpo=this.texto_corpo_orig; 
    this.isLoading="";
    this.searching = false;
    this.codes=[];
    return this.codes ;
